...
//     <td class="product-remove"> <a class="remove remove-item-in-cart"><span class="fa fa-times"></span></a></td>\
//     </tr>'
...
//     Cart.addItem(item);
//   });
//   $(document).on('click', '.remove-item-in-cart', function(e) {
//     e.preventDefault();
...
//     console.log(button);
//   });
//   $(document).on('click', '#update-in-cart', function(e) {
//     e.preventDefault();
//     var button = $(this);
//     update();
