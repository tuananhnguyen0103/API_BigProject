            ...
            htmlTag+='<div class="col-12 col-lg-6 col-xl-4">\
				  <div class="box">\
					<div class="fx-card-item">\
						<div class="fx-card-avatar fx-overlay-1" style ="width: 24rem;height: 26rem;"> <img style = "max-height: 80%;max-width: 80%; margin: 2rem;" src="'+element.image+'" alt="user" class="bbsr-0 bber-0">\
							<div class="fx-overlay scrl-up">\
								<ul class="fx-info">\
									...
									<li><a class="btn btn-outline" href="/Html/Admin/html/main/ecommerce_products_edit.html?id='+element.id+'"><i class="mdi mdi-settings"></i></a></li>\
								</ul>\
							</div>\
						</div>\
